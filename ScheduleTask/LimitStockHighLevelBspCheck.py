...
print(stock_list)
lv_list = [KL_TYPE[kl_type] for kl_type in schedule_config["limit_stock_high_level_list"]]

begin_time = schedule_config["limit_stock_high_level_begin"]
end_time = schedule_config["limit_stock_high_level_end"]
config = CChanConfig({
        "bi_algo": "advanced",
        "bi_strict": False,
        "trigger_step": True,
...
def limit_stock_high_level_bsp_check_main():
